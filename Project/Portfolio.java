...
public class Portfolio {
	...
	// Sums and returns the initialCost of all the Project objects in the Portfolio
	...
	// Prints the elevatorPitch for all Project objects in the Portfolio ArrayList
	// then prints the cost of the entire Portfolio.
